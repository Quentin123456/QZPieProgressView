...
#import "QZPieLoopProgressView.h"

@implementation QZPieLoopProgressView
...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat radius = MIN(rect.size.width * 0.5, rect.size.height * 0.5) - QZProgressViewItemMargin * 0.2;
